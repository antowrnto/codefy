          ...
          <div class="card-content">
            <div class="card-body text-center">
              ...
              <div class="text-center">
                <h1 class="mb-2 text-white">{{ $greeting  }} {{ Auth::user()->name }} Welcome To Codefy</h1>
                <p class="m-auto w-75">{{ $quote }}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-6 col-12">
        <div class="card">
          <div class="card-header d-flex flex-column align-items-start pb-0">
            ...
            <h2 class="text-bold-700 mt-1 mb-25">{{ $countDataUsers }}</h2>
            <p class="mb-0">Student Subscribers</p>
          </div>
          <div class="card-content">
      ...
      <div class="col-lg-3 col-md-6 col-12">
        <div class="card">
          <div class="card-header d-flex flex-column align-items-start pb-0">
            ...
            <h2 class="text-bold-700 mt-1 mb-25">{{ $countDataCourses }}</h2>
            <p class="mb-0">Course Received</p>
          </div>
          <div class="card-content">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="mb-0">Dispatched confirmation payment</h4>
          </div>
          <div class="card-content">
